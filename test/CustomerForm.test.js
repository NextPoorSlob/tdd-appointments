...
describe("CustomerForm", () => {
    ...
    const itAssignsAnIdThatMatchesTheLabelId = (
        ...
        it(`assigns an id of '${fieldName}' matching the label id`, () => {
            render(<CustomerForm original={blankCustomer}/>);
    ...
    const itSubmitsExistingValue = (fieldName, value) => {
        it(`saves existing value '${value}' when submitted`, () => {
    ...
    const itSubmitsNewValue = (fieldName, value) => {
        it(`saves new value '${value}' when submitted`, () => {
            expect.hasAssertions();
            render(
                <CustomerForm
                    original={blankCustomer}
    ...
    describe("last name field", () => {
        ...
        itSubmitsNewValue("lastName", "Turducken");
    });

    describe("phone number field", () => {
        itRendersAsATextBox("phoneNumber");
        itIncludesTheExistingValue("phoneNumber", "312-555-1212");
        itRendersALabel("phoneNumber", "Phone number");
        itAssignsAnIdThatMatchesTheLabelId("phoneNumber");
        itSubmitsExistingValue("phoneNumber", "312-555-1212");
        itSubmitsNewValue("phoneNumber", "708-555-1212");
    });
